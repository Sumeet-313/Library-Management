...
pw.println("<td align='right' style='border:1px solid black'><a href='javascript:deleteBook("+book.getCode()+",\""+book.getTitle()+"\")'><imgsrc='/crudone/images/delete_icon.png' style='padding:5px'></a></td>");
pw.println("</tr>");
}
pw.println("</tbody>");
pw.println("</table>");
